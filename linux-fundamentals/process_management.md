...
- You can change the priority of a process by changing its niceness value (-20 - 19). The net priority is the sum of the niceness and the priority value. To increase the priority, use `renice <value> <pid>` and provide a negative value. Thi will bring down the overall priority
